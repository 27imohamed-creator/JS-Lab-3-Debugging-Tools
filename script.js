...
/* to open the console, right click, click inspect, then click on console */
/* 3.  Use the console.log() method to make a it say "Hello from the Console!" in the console*/
